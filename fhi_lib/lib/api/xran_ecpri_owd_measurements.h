...
enum xran_owd_meas_method { XRAN_REQUEST = 0, XRAN_REM_REQ, XRAN_REQ_WFUP, XRAN_REM_REQ_WFUP };

enum xran_owdm_tx_state { OWDMTX_INIT = 0, OWDMTX_IDLE, OWDMTX_ACTIVE, OWDTX_DONE };
