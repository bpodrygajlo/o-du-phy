...
void BlockFloatCompander::BFPCompressCtrlPlane64AvxSnc(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    ...
    case 9:
      BFP_CPlane_64_SNC::compressByAllocN<BlockFloatCompander::networkBytePack9bSnc>(dataIn,
                                                                                     dataOut,
                                                                                     totShiftBits9,
                                                                                     totNumBytesPerBlock,
                                                                                     totNumBytesPerReg,
    ...
    case 10:
      BFP_CPlane_64_SNC::compressByAllocN<BlockFloatCompander::networkBytePack10bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits10,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
    ...
    case 12:
      BFP_CPlane_64_SNC::compressByAllocN<BlockFloatCompander::networkBytePack12bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits12,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
    ...
    case 14:
      BFP_CPlane_64_SNC::compressByAllocN<BlockFloatCompander::networkBytePack14bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits14,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
...
/// Starts by determining iqWidth specific parameters and functions.
void BlockFloatCompander::BFPExpandCtrlPlane64AvxSnc(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    ...
    case 9:
      BFP_CPlane_64_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack9bSnc>(dataIn,
                                                                                     dataOut,
                                                                                     totNumBytesPerBlock,
                                                                                     totNumBytesPerReg,
                                                                                     k_maxExpShift9);
    ...
    case 10:
      BFP_CPlane_64_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack10bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
                                                                                      k_maxExpShift10);
    ...
    case 12:
      BFP_CPlane_64_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack12bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
                                                                                      k_maxExpShift12);
    ...
    case 14:
      BFP_CPlane_64_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack14bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      totNumBytesPerReg,
                                                                                      k_maxExpShift14);
