...
#ifdef C_Module_Used
void mod_compression_qpsk_c(int16_t *pData, int8_t *pOut, int16_t unit, int32_t nSc)
{
...
void mod_compression_16qam_c(int16_t *pData, int8_t *pOut, int16_t unit, int32_t nSc)
{
...
void mod_compression_64qam_c(int16_t *pData, int8_t *pOut, int16_t unit, int32_t nSc)
{
...
void mod_compression_256qam_c(int16_t *pData, int8_t *pOut, int16_t unit, int32_t nSc)
{
...
{
  __m512i permute_index = _mm512_set_epi16(24,
                                           25,
                                           26,
                                           27,
                                           28,
...
inline __m512i byte_pack2b(const __m512i comp_data)
{
  const __m512i k_shift_left = _mm512_set_epi64(0x0000000200040006,
                                                0x0000000200040006,
                                                0x0000000200040006,
                                                0x0000000200040006,
                                                0x0000000200040006,
  ...
  const __m512i k_byte_shufflemask1 = _mm512_set_epi64(0x0000000000000000,
                                                       0x0000000000000800,
                                                       0x0000000000000000,
                                                       0x0000000000000800,
                                                       0x0000000000000000,
  ...
  const __m512i k_byte_shufflemask2 = _mm512_set_epi64(0x0000000000000000,
                                                       0x0000000000000A02,
                                                       0x0000000000000000,
                                                       0x0000000000000A02,
                                                       0x0000000000000000,
  ...
  const __m512i k_byte_shufflemask3 = _mm512_set_epi64(0x0000000000000000,
                                                       0x0000000000000C04,
                                                       0x0000000000000000,
                                                       0x0000000000000C04,
                                                       0x0000000000000000,
  ...
  const __m512i k_byte_shufflemask4 = _mm512_set_epi64(0x0000000000000000,
                                                       0x0000000000000E06,
                                                       0x0000000000000000,
                                                       0x0000000000000E06,
                                                       0x0000000000000000,
  ...
  const __m512i k_ternlog_select1 = _mm512_set_epi64(0x0000000000000000,
                                                     0x0000000000003030,
                                                     0x0000000000000000,
                                                     0x0000000000003030,
                                                     0x0000000000000000,
  ...
  const __m512i k_ternlog_select2 = _mm512_set_epi64(0x0000000000000000,
                                                     0x0000000000000C0C,
                                                     0x0000000000000000,
                                                     0x0000000000000C0C,
                                                     0x0000000000000000,
  ...
  const __m512i k_ternlog_select3 = _mm512_set_epi64(0x0000000000000000,
                                                     0x0000000000000303,
                                                     0x0000000000000000,
                                                     0x0000000000000303,
                                                     0x0000000000000000,
...
inline __m512i byte_pack2b_snc(const __m512i comp_data)
{
  const __m512i k_shift_left = _mm512_set_epi64(0x0000000200040006,
                                                0x0000000200040006,
                                                0x0000000200040006,
  ...
  const auto k_byte_permute = _mm512_setr_epi32(0x11100100,
                                                0x31302120,
                                                0xFFFFFFFF,
                                                0xFFFFFFFF,
                                                0xFFFFFFFF,
...
inline __m512i byte_pack3b(const __m512i comp_data)
{
  const __m512i k_shift_left = _mm512_set_epi64(0x0000000300060001,
                                                0x0004000700020005,
                                                0x0000000300060001,
                                                0x0004000700020005,
                                                0x0000000300060001,
  ...
  const __m512i k_shift_right = _mm512_set_epi64(0x0000000000020000,
                                                 0x0000000100000000,
                                                 0x0000000000020000,
                                                 0x0000000100000000,
                                                 0x0000000000020000,
...
inline __m512i byte_pack3b_snc(const __m512i comp_data)
{
  const __m512i k_shift_left = _mm512_set_epi64(0x0000000300060001,
                                                0x0004000700020005,
                                                0x0000000300060001,
  ...
  const auto k_byte_permute = _mm512_setr_epi32(0x10020100,
                                                0x21201211,
                                                0x32313022,
                                                0xFFFFFFFF,
                                                0xFFFFFFFF,
...
inline __m512i byte_pack4b(const __m512i comp_data)
{
  const __m512i k_shift_Left = _mm512_set_epi64(0x0000000400000004,
                                                0x0000000400000004,
                                                0x0000000400000004,
                                                0x0000000400000004,
                                                0x0000000400000004,
  ...
  /// Ternary blend of the two shuffled results
  const __m512i k_ternlog_select = _mm512_set_epi64(0x0000000000000000,
                                                    0x000000000F0F0F0F,
                                                    0x0000000000000000,
                                                    0x000000000F0F0F0F,
                                                    0x0000000000000000,
  ...
  const __m512i k_dwordmask = _mm512_set_epi64(0x0000000F0000000F,
                                               0x0000000F0000000F,
                                               0x0000000F0000000F,
                                               0x0000000F0000000F,
                                               0x0000000F0000000F,
...
void mod_decompression_qpsk_c(int8_t *pData, int16_t *pOut, int16_t unit, int32_t nSc, int16_t re_mask)
{
...
void mod_decompression_16qam_c(int8_t *pData, int16_t *pOut, int16_t unit, int32_t nSc)
{
...
void mod_decompression_64qam_c(int8_t *pData, int16_t *pOut, int16_t unit, int32_t nSc)
{
...
void mod_decompression_256qam_c(int8_t *pData, int16_t *pOut, int16_t unit, int32_t nSc)
{
