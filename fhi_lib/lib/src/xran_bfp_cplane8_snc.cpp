...
inline __m512i maxAbsOneReg(const __m512i maxAbs, const __m512i* inData, const int pairNum)
{
  ...
  const auto k_selectVals = _mm512_set_epi32(24, 16, 24, 16, 24, 16, 24, 16, 24, 16, 24, 16, 24, 16, 24, 16);
...
template <BlockFloatCompander::PackFunction networkBytePack>
inline void applyCompressionN_2RB(const __m512i* dataIn,
                                  uint8_t* outBlockAddr,
                                  const int totNumBytesPerBlock,
                                  const int iqWidth,
                                  const uint8_t* theseExps,
                                  const uint32_t rbWriteMask)
{
  /// Store exponents first
...
#pragma unroll(8)
  for (int n = 0; n < 8; ++n) {
    applyCompressionN_2RB<networkBytePack>(dataInAddr + n,
                                           dataOut->dataCompressed + n * 2 * totNumBytesPerBlock,
                                           totNumBytesPerBlock,
                                           dataIn.iqWidth,
                                           ((uint8_t*)&exponents) + n * 8,
                                           rbWriteMask);
  }
}
...
inline void applyCompression8_1RB(const __m256i* dataIn, uint8_t* outBlockAddr, const uint8_t thisExp)
{
...
inline void applyExpansionN_1RB(const uint8_t* expAddr, __m256i* dataOutAddr, const int maxExpShift)
{
...
inline void applyExpansion8_1RB(const uint8_t* expAddr, __m256i* dataOutAddr)
{
...
void BlockFloatCompander::BFPCompressCtrlPlane8AvxSnc(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  constexpr uint32_t rbWriteMask14 = 0x0FFFFFFF;
  ...
  switch (dataIn.iqWidth) {
    ...
    case 9:
      BFP_CPlane_8_SNC::compressByAllocN<BlockFloatCompander::networkBytePack9bSncB>(dataIn,
                                                                                     dataOut,
                                                                                     totShiftBits9,
                                                                                     totNumBytesPerBlock,
                                                                                     rbWriteMask9);
    ...
    case 10:
      BFP_CPlane_8_SNC::compressByAllocN<BlockFloatCompander::networkBytePack10bSncB>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits10,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask10);
    ...
    case 12:
      BFP_CPlane_8_SNC::compressByAllocN<BlockFloatCompander::networkBytePack12bSncB>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits12,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask12);
    ...
    case 14:
      BFP_CPlane_8_SNC::compressByAllocN<BlockFloatCompander::networkBytePack14bSncB>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits14,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask14);
...
/// Starts by determining iqWidth specific parameters and functions.
void BlockFloatCompander::BFPExpandCtrlPlane8AvxSnc(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    ...
    case 9:
      BFP_CPlane_8_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack9b256Snc>(dataIn,
                                                                                       dataOut,
                                                                                       totNumBytesPerBlock,
                                                                                       k_maxExpShift9);
      break;
    ...
    case 10:
      BFP_CPlane_8_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack10b256Snc>(dataIn,
                                                                                        dataOut,
                                                                                        totNumBytesPerBlock,
                                                                                        k_maxExpShift10);
      break;
    ...
    case 12:
      BFP_CPlane_8_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack12b256Snc>(dataIn,
                                                                                        dataOut,
                                                                                        totNumBytesPerBlock,
                                                                                        k_maxExpShift12);
      break;
    ...
    case 14:
      BFP_CPlane_8_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack14b256Snc>(dataIn,
                                                                                        dataOut,
                                                                                        totNumBytesPerBlock,
                                                                                        k_maxExpShift14);
      break;
