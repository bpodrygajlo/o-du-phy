...
/* PRACH data samples are 32 bits wide, 16bits for I and 16bits for Q. Each packet contains 839 samples for long sequence or 144 for
 * short sequence. The payload length is 840*16*2/8 octets.*/
...
#define XranDiffSymIdx(prevSymIdx, currSymIdx, numTotalSymIdx) \
