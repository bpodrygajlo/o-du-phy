...
void BlockFloatCompander::BFPCompressCtrlPlane16Avx512(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    ...
    case 9:
      BFP_CPlane_16::compressByAllocN<BlockFloatCompander::networkBytePack9b>(dataIn,
                                                                              dataOut,
                                                                              totShiftBits9,
                                                                              totNumBytesPerBlock,
                                                                              rbWriteMask9);
    ...
    case 10:
      BFP_CPlane_16::compressByAllocN<BlockFloatCompander::networkBytePack10b>(dataIn,
                                                                               dataOut,
                                                                               totShiftBits10,
                                                                               totNumBytesPerBlock,
                                                                               rbWriteMask10);
    ...
    case 12:
      BFP_CPlane_16::compressByAllocN<BlockFloatCompander::networkBytePack12b>(dataIn,
                                                                               dataOut,
                                                                               totShiftBits12,
                                                                               totNumBytesPerBlock,
                                                                               rbWriteMask12);
...
/// Starts by determining iqWidth specific parameters and functions.
void BlockFloatCompander::BFPExpandCtrlPlane16Avx512(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    ...
    case 10:
      BFP_CPlane_16::expandByAllocN<BlockFloatCompander::networkByteUnpack10b>(dataIn,
                                                                               dataOut,
                                                                               totNumBytesPerBlock,
                                                                               k_maxExpShift10);
      break;
    ...
    case 12:
      BFP_CPlane_16::expandByAllocN<BlockFloatCompander::networkByteUnpack12b>(dataIn,
                                                                               dataOut,
                                                                               totNumBytesPerBlock,
                                                                               k_maxExpShift12);
      break;
