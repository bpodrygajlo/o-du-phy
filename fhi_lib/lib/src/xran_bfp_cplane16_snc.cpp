                                  ...
                                  const uint64_t rbWriteMask)
{
  ...
  *outBlockAddr = thisExp;
  ...
  _mm512_mask_storeu_epi8(outBlockAddr + 1, rbWriteMask, compDataBytePacked);
}
...
#pragma unroll(16)
  for (int n = 0; n < 16; ++n) {
    applyCompressionN_1RB<networkBytePack>(dataInAddr + n,
...
inline void applyExpansionN_1RB(const uint8_t* expAddr, __m512i* dataOutAddr, const int maxExpShift)
{
...
void BlockFloatCompander::BFPCompressCtrlPlane16AvxSnc(const ExpandedData& dataIn, CompressedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    case 8:
      BFP_CPlane_16_SNC::compressByAlloc8(dataIn, dataOut, totShiftBits8);
      break;

    case 9:
      BFP_CPlane_16_SNC::compressByAllocN<BlockFloatCompander::networkBytePack9bSnc>(dataIn,
                                                                                     dataOut,
                                                                                     totShiftBits9,
                                                                                     totNumBytesPerBlock,
                                                                                     rbWriteMask9);
    ...
    case 10:
      BFP_CPlane_16_SNC::compressByAllocN<BlockFloatCompander::networkBytePack10bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits10,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask10);
    ...
    case 12:
      BFP_CPlane_16_SNC::compressByAllocN<BlockFloatCompander::networkBytePack12bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits12,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask12);
    ...
    case 14:
      BFP_CPlane_16_SNC::compressByAllocN<BlockFloatCompander::networkBytePack14bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totShiftBits14,
                                                                                      totNumBytesPerBlock,
                                                                                      rbWriteMask14);
...
/// Starts by determining iqWidth specific parameters and functions.
void BlockFloatCompander::BFPExpandCtrlPlane16AvxSnc(const CompressedData& dataIn, ExpandedData* dataOut)
{
  ...
  switch (dataIn.iqWidth) {
    case 8:
      BFP_CPlane_16_SNC::expandByAlloc8(dataIn, dataOut);
      break;

    case 9:
      BFP_CPlane_16_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack9bSnc>(dataIn,
                                                                                     dataOut,
                                                                                     totNumBytesPerBlock,
                                                                                     k_maxExpShift9);
      break;
    ...
    case 10:
      BFP_CPlane_16_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack10bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      k_maxExpShift10);
      break;
    ...
    case 12:
      BFP_CPlane_16_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack12bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      k_maxExpShift12);
      break;
    ...
    case 14:
      BFP_CPlane_16_SNC::expandByAllocN<BlockFloatCompander::networkByteUnpack14bSnc>(dataIn,
                                                                                      dataOut,
                                                                                      totNumBytesPerBlock,
                                                                                      k_maxExpShift14);
      break;
